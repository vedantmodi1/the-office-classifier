...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        var url = "http://127.0.0.1:5000/classify_image"; //for when i dont use nginx
        //var url = "/api/classify_image";                    //when i am using nginx
        ...
        $.post(url, {
            ...
            */
            ...
            let players = ["dwight", "jim", "kelly", "michael", "pam"];
